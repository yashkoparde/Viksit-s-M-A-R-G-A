...
// ── Keep-alive: prevent crashes from killing the server process ──────────────
process.on('uncaughtException', (err) => {
  console.error('[MARGA] Uncaught Exception (server kept alive):', err.message);
});

process.on('unhandledRejection', (reason) => {
  console.error('[MARGA] Unhandled Rejection (server kept alive):', reason);
});
